defmodule WooviSdk.WebhookTest do
  ...
  test "valid?/2 returns true with valid webhook" do
    assert Webhook.valid?(@payload, @signature)
  end

  test "valid?/2 returns false with invalid signature" do
    refute Webhook.valid?(@payload, "invalid-signature")
  end

  test "valid?/2 returns false with invalid payload" do
    refute Webhook.valid?("invalid-payload", @signature)
  end
end
